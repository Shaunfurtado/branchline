...
These evaluations are designed for a compatible browser agent operating the live BRANCHLINE page. Start with `?fresh=1`, trigger the featured supplier shock, and keep the Capability Dock visible when evaluating lifecycle behavior.
